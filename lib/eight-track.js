...
EightTrack.prototype = {
  ...
  forwardRequest: function (localReq, callback) {
    ...
    // Forward the request
    return this.forwardRequestMessage(localReqMsg, callback);
  },

  forwardBufferedRequest: function (localReq, localBuff, callback) {
    var localReqMsg = new Message(localReq, {body: localBuff});
    return this.forwardRequestMessage(localReqMsg, callback);
  },

  forwardRequestMessage: function (localReqMsg, callback) {
    // Define common variables for waterfall
